...
/**
 * Fired at the inviter when the invitee accepts their agent invitation.
 * Renders {@code notification.agent-invite-accepted}.
 */
public final class AgentInviteAcceptedEvent extends RealtyNotificationEvent {

    private final UUID inviterId;
    private final UUID inviteeId;
    private final String inviteeName;

    public AgentInviteAcceptedEvent(@NotNull UUID targetId,
